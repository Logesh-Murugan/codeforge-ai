...
class TestExportSchemas:
    ...
    def test_report_type_enum(self):
        ...
        assert len(list(ReportType)) == 14  # 13 reports + FULL_PROJECT
...
class TestReportExporters:
    ...
    def test_export_agent_execution(self):
        ...
        assert "project_manager" in report.content.lower()
...
class TestReportService:
    ...
    def test_generate_all_reports(self):
        ...
        assert len(reports) == 13  # All except FULL_PROJECT
...
class TestExportService:
    ...
    def test_describe_export(self):
        ...
        assert len(result.reports_generated) == 13
