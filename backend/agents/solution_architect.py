...
from app.schemas import BusinessAnalystResponse, SolutionArchitectResponse
...
class SolutionArchitectAgent:
    ...
    def run(self, business_requirements: BusinessAnalystResponse) -> SolutionArchitectResponse:
        """
        ...
        """
        # Convert business requirements to JSON string
