...
from app.schemas import FrontendDeveloperResponse, SolutionArchitectResponse, BackendDeveloperResponse

logger = logging.getLogger(__name__)


class FrontendDeveloperAgent:
    """Agent that creates Next.js project files from solution design and backend implementation."""
    ...
    def run(self, solution_arch: SolutionArchitectResponse, backend_code: BackendDeveloperResponse) -> FrontendDeveloperResponse:
        """
        ...
        Returns:
            Structured FrontendDeveloperResponse.
    ...
    def _parse_response(self, response_str: str) -> FrontendDeveloperResponse:
